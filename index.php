...
<!-- apresentação da ideia da pagina -->
  ...
  <div class="titulo">
    <h4> Pagina INDEX da parte dinamica!</h4>
      * criar sessao - com validacao de usuario e senha no banco previamente cadastrado; <br>
      * enviar resposta da pergunta a tb_resposta;<br>
      *buscar no banco as perguntas conforme o valor da varivel de controle;<br>
      * definir o perfil do investidor;<br>
      *sugerir a carteira de investimentos;<br>
      *criar form de endereco, com a API de validação;<br>
